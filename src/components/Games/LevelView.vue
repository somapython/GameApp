    ...
    return {
      ...
      3: { type: 'sequence memory', question: 'Memorize this sequence:', sequence: ['3', '7', '1', '9', '4'], timeToShow: 5000,answer:'37194' },    
        ...
        7: { type: 'image-match', question: 'Match the animals to their names.',images: [
            ...
            answer: ['Cat', 'Dog', 'Lion']},
         8: { type: 'word unscramble', question: 'Unscramble the word: "ETUSTITNI"', answer: 'INSTITUTE' },
         9: { type: 'sequence memory', question: 'Memorize this sequence:', sequence: ['5', '9', '2', '4', '4'], timeToShow: 5000,answer:'59244' },
         10: { type: 'memory', question: 'Match the pairs.', pairs: ['GG', 'HH', 'II', 'GG', 'HH', 'II'], answer: ['GG', 'HH', 'II'] },
         11: { type: 'drag-drop', question: 'Rearrange the letters to form the word.', pieces: ['S', 'C', 'H', 'S','E'], answer: 'CHESS'},
        12: { type: 'sequence memory', question: 'Memorize this sequence:', sequence: ['8', '7', '7', '4', '1'], timeToShow: 5000,answer:'87741' },
        13: { type: 'word unscramble', question: 'Unscramble the word: "ESATOFWR"', answer: 'SOFTWARE' },
        14: { type: 'image-match', question: 'Match the animals to their names.',images: [
            { src: hatImages, name: 'Hat' },
            { src: batImages, name: 'Bat' },
            { src: bagImages, name: 'Bag' }],
            answer: ['Hat', 'Bat', 'Bag']},
        15: { type: 'general knowledge', question: 'What is the largest planet in our solar system?', answer: 'Jupiter' },
        16: { type: 'vocabulary', question: 'What is the antonym of "Ancient"?', options: ['Modern', 'Old'], answer: 'Modern' },
        17: { type: 'logic', question: 'I am not alive, but I can grow. I don’t have lungs, but I need air. What am I?', answer: 'Fire' },
        18: { type: 'word-search', question: 'Find the hidden words:', grid: [
          'B', 'L', 'U', 'E', 
         'W', 'O', 'R', 'D', 
         'S', 'I', 'T', 'C'],
